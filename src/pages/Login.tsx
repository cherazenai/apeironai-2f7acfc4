      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md relative z-10">
        ...
        <Card className="glass glow-border">
          ...
          <CardContent className="space-y-4 pt-4">
            <Button onClick={handleGoogleLogin} variant="outline" className="w-full glass-hover gap-2">
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <div className="relative">
                ...
                <Input type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 bg-card-elevated border-border" required />
              </div>
